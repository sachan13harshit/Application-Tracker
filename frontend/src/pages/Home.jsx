...
const Home = () => {
  ...
  return (
    <>
     <div className="block justify-between lg:flex min-h-screen pt-4 md:pt-12 px-4 md:px-8 gap-4">
  ...
  <div className="lg:w-2/5 h-fit md:max-w-lg mx-auto bg-blue-200 rounded-xl pt-5 mb-5 mclaren flex flex-col justify-center">
